...
public class BloAdapter extends BaseAdapter {
    private int[] img = {R.drawable.bb1,R.drawable.loc};

    Context context;
    ArrayList<BloClass> arrayList;
    public BloAdapter(Context context, ArrayList<BloClass>arrayList){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        BloClass ambClass = arrayList.get(i);
