...
public class PhyAdapter  extends BaseAdapter {
    private int[] img = {R.drawable.phy2,R.drawable.loc};
    Context context;
    ArrayList<PhyClass> arrayList;
    public PhyAdapter(Context context, ArrayList<PhyClass>arrayList){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        PhyClass ambClass = arrayList.get(i);
