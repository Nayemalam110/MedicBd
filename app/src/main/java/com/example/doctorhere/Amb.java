...
public class Amb extends AppCompatActivity implements View.OnClickListener {
    Spinner spinnerdis,spinnerarea;
    Button buttonhospitalsearch;
    ListView hospitallistview;
    ArrayList<DisClass> dislist;
    DatabaseHelper myDbHelper;
    DisAdaptar disAdaptar;
    int disid,areaid;
    ArrayList<HosClass> Hoslistdata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonhospitalsearch=findViewById(R.id.hospitalsearchbuttonbid);
        hospitallistview=findViewById(R.id.hoslistviewid);

        buttonhospitalsearch.setOnClickListener(this);
        dislist = new ArrayList<>();
        Hoslistdata=new ArrayList<>();
    ...
    private void loadDis() {
        ...
        myDbHelper = new DatabaseHelper(Amb.this);
        try {
    ...
    private void loadArea() {
        ...
        Cursor c = myDbHelper.displayAreadata(disid);
        if (c.getCount()==0)
        {
    ...
    public void onClick(View view) {
        {
                ...
                if(areaid==0)
                {
                    ...
                    Cursor c = myDbHelper.displayallHospitalData(disid);
                    if (c.getCount()==0)
                    {
...

                {
                    ...
                    Cursor c = myDbHelper.displayHospitalData(areaid);
                    if (c.getCount()==0)
                    {
